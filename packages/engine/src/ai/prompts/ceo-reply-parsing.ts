...
Set "should_replan" to true if the owner's reply implies a change in direction that warrants replanning (e.g. pivot, drop everything, new priority). Simple approvals, holds, questions, and general comments should be false.`;
